...
namespace LoginScreen___Game {
    ...
    public partial class UsersDBDataSet : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public UsersRow AddUsersRow(string Firstname, string Surname, string Username, string Password, string Email) {
...
namespace LoginScreen___Game.UsersDBDataSetTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Users` WHERE ((`UserID` = ?) AND ((? = 1 AND `Firstname` IS NULL) OR (`Firstname` = ?)) AND ((? = 1 AND `Surname` IS NULL) OR (`Surname` = ?)) AND ((? = 1 AND `Username` IS NULL) OR (`Username` = ?)) AND ((? = 1 AND `Password` IS NULL) OR (`Password` = ?)) AND ((? = 1 AND `Email` IS NULL) OR (`Email` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Users` (`Firstname`, `Surname`, `Username`, `Password`, `Email`) VAL" +
                "UES (?, ?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Users` SET `Firstname` = ?, `Surname` = ?, `Username` = ?, `Password` = ?, `Email` = ? WHERE ((`UserID` = ?) AND ((? = 1 AND `Firstname` IS NULL) OR (`Firstname` = ?)) AND ((? = 1 AND `Surname` IS NULL) OR (`Surname` = ?)) AND ((? = 1 AND `Username` IS NULL) OR (`Username` = ?)) AND ((? = 1 AND `Password` IS NULL) OR (`Password` = ?)) AND ((? = 1 AND `Email` IS NULL) OR (`Email` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::LoginScreen___Game.Properties.Settings.Default.UsersDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT UserID, Firstname, Surname, Username, [Password], Email FROM Users";
        ...
        public virtual int Delete(int Original_UserID, string Original_Firstname, string Original_Surname, string Original_Username, string Original_Password, string Original_Email) {
        ...
        public virtual int Insert(string Firstname, string Surname, string Username, string Password, string Email) {
            if ((Firstname == null)) {
        ...
        public virtual int Update(string Firstname, string Surname, string Username, string Password, string Email, int Original_UserID, string Original_Firstname, string Original_Surname, string Original_Username, string Original_Password, string Original_Email) {
            if ((Firstname == null)) {
